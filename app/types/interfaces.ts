...
// A jig that would disappear from the JIG page if jigCount were reduced to
// exclude it, and which still has jobs actively loaded on it — see
// getJigsAtRiskOfReduction.
export interface IJigAtRisk {
  jigName: string
  jobs: Pick<IJob, "id" | "po_number" | "customer_name">[]
}
